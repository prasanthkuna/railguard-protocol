...
```ts
import { buildPaymentIntent, createX402Guard } from "@railguard/sdk"

const guard = createX402Guard("agent_demo")
```

Depends on `@railguard/x402` and `@railguard/x402-core`.
...
npm run build
$core = npm pack -w @railguard/x402-core --silent
$policy = npm pack -w @railguard/x402-policy --silent
$receipts = npm pack -w @railguard/x402-receipts --silent
$mw = npm pack -w @railguard/x402 --silent
